...
const ViewAssesmentDialog: React.FC = () => {
  return (
    <div>
      <Stack
        direction="row"
      ...
      >
        <div>
          ...
          >
            ...
            প্রধানত প্রকৃতির কবি| তার রচিত কাব্যগ্রন্থের নাম 'ধূসর পাণ্ডুলিপি',
            'সাতটি তারার তিমির', 'বেলা অবেলা কালবেলা' এবং 'রুপসী বাংলা' প্রভৃতি|
          </Typography>
        </div>
        <Button variant="contained" sx={{ bgcolor: '#1D1D1F' }}>
          1 point
      ...
      >
        <div>
          <Typography variant="h6" my={2}>
            <strong>Question: 1</strong> Select your preferences_______________
          </Typography>
      ...
      >
        <div>
          ...
          >
            ...
            দক্ষিণ কলকাতা ছিল “হোয়াইট টাউন”) নামে পরিচিত উত্তর কলকাতার চিৎপুর
            রোডের (বর্তমান নাম রবীন্দ্র সরণি) নিকটে।
          </Typography>
        </div>
        <Button variant="contained" sx={{ bgcolor: '#1D1D1F' }}>
          1 point
