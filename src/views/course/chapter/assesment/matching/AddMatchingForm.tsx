...
const AddMatchingForm: React.FC<any> = ({ assessmentId = '7', handleCloseDialog }) => {
  ...
  const toggleGrid = (index: number) => {
    setDeletedGrids((prev) => {
      const indexInDeletedGrids = prev.indexOf(index);

      if (indexInDeletedGrids === -1) {
        return [...prev, index];
      } else {
        const newDeletedGrids = [...prev];
        newDeletedGrids.splice(indexInDeletedGrids, 1);
        return newDeletedGrids;
      }
    });
  ...
  return (
    <Formik
      initialValues={{
        ...
        wrong_answer: '',
        items: [
          { id: 1, placeholder: 'Email 1', option_key: '',option_value: '', wrong_answer: '' },
          { id: 2, placeholder: 'Email 2', option_key: '',option_value: '', wrong_answer: '' },
          { id: 3, placeholder: 'Email 3', option_key: '',option_value: '', wrong_answer: '' },
          { id: 4, placeholder: 'Email 4', option_key: '',option_value: '', wrong_answer: '' },
        ],
      }}
