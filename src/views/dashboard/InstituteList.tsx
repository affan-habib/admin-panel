...
//     { id: 4, currentBatch: t('batchNo'), currentCourse: t('learningField'), number: t('numberOfTrainee'), progress: t('progress'), duration: t('courseDuration') },
//     { id: 5, currentBatch: t('batchNo'), currentCourse: t('learningField'), number: t('numberOfTrainee'), progress: t('progress'), duration: t('courseDuration') },
//   ];
